...
class StoresTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'img_path' => 'http://localhost:8000/storage/sushi.jpeg'
        ];
        $area = new Store;
        ...
        $param = [
            ...
            'img_path' => 'http://localhost:8000/storage/yakiniku.jpeg'
        ];
        $area = new Store;
        $area->fill($param)->save();
        ...
        $param = [
            ...
            'img_path' => 'http://localhost:8000/storage/izakaya.jpeg'
        ];
        $area = new Store;
        $area->fill($param)->save();
        ...
        $param = [
            ...
            'img_path' => 'http://localhost:8000/storage/italian.jpeg'
        ];
        $area = new Store;
        $area->fill($param)->save();
        ...
        $param = [
            ...
            'img_path' => 'http://localhost:8000/storage/ramen.jpeg'
        ];
        $area = new Store;
        $area->fill($param)->save();
