...
class StoresTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'img_path' => 'https://mysterious-plateau-61386.herokuapp.com/storage/app/public/sushi.jpeg'
        ];
        $area = new Store;
        ...
        $param = [
            ...
            'img_path' => 'https://mysterious-plateau-61386.herokuapp.com/storage/yakiniku.jpeg'
        ];
        $area = new Store;
        $area->fill($param)->save();
        ...
        $param = [
            ...
            'img_path' => 'https://mysterious-plateau-61386.herokuapp.com/storage/izakaya.jpeg'
        ];
        $area = new Store;
        $area->fill($param)->save();
        ...
        $param = [
            ...
            'img_path' => 'https://mysterious-plateau-61386.herokuapp.com/storage/italian.jpeg'
        ];
        $area = new Store;
        $area->fill($param)->save();
        ...
        $param = [
            ...
            'img_path' => 'https://mysterious-plateau-61386.herokuapp.com/storage/ramen.jpeg'
        ];
        $area = new Store;
        $area->fill($param)->save();
        ...
        $param = [
            ...
            'img_path' => 'https://mysterious-plateau-61386.herokuapp.com/storage/sushi.jpeg'
        ];
        $area = new Store;
        $area->fill($param)->save();
